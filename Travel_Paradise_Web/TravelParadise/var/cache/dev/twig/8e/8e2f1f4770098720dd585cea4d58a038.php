...
/* user/edit.html.twig */
class __TwigTemplate_6656147549374a446edca485e911b3c5 extends Template
{
    ...
    public function block_app_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Modifier Utilisateur - TravelParadise";
    ...
    <div class=\"max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md\">
        ...
        <h2 class=\"text-2xl font-bold text-gray-800 mb-6 text-center\">Modifier Utilisateur</h2>

        ";
        // line 13
        yield from $this->load("user/_form.html.twig", 13)->unwrap()->yield(CoreExtension::merge($context, ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "user" => (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 13, $this->source); })())]));
        // line 14
        yield "
        ";
        // line 15
        yield from $this->load("user/_delete_form.html.twig", 15)->unwrap()->yield($context);
        // line 16
        yield "
    </div>
...
";
    ...
    {
        return array (  138 => 16,  136 => 15,  133 => 14,  131 => 13,  124 => 8,  111 => 7,  88 => 5,  65 => 4,  42 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{# templates/user/edit.html.twig #}
{% extends 'layout_app.html.twig' %}

{% block app_title %}Modifier Utilisateur - TravelParadise{% endblock %}
...
{% block content %}
    ...
    <div class=\"max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md\">
        ...
        {% include 'user/_form.html.twig' with {'form': form, 'user': user} %}
