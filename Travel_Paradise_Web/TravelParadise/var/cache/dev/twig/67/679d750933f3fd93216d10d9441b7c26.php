...
/* user/new.html.twig */
class __TwigTemplate_8fd8b372237327842f823ce60c531690 extends Template
{
    ...
    public function block_app_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Nouvel Utilisateur - TravelParadise";
    ...
    <div class=\"max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md\">
        ...
        <h2 class=\"text-2xl font-bold text-gray-800 mb-6 text-center\">Nouvel utilisateur</h2>

        ";
        // line 13
        yield from $this->load("user/_form.html.twig", 13)->unwrap()->yield(CoreExtension::merge($context, ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })())]));
        // line 14
        yield "
    </div>
...
";
    ...
    {
        return array (  133 => 14,  131 => 13,  124 => 8,  111 => 7,  88 => 5,  65 => 4,  42 => 2,);
    }
...
{% block app_title %}Nouvel Utilisateur - TravelParadise{% endblock %}
