...
/* broadcast/Visite.stream.html.twig */
class __TwigTemplate_6ef1ea89733d0a04195806b5b9d5ab6d extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "broadcast/Visite.stream.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "broadcast/Visite.stream.html.twig"));
...
";
    ...
    public function block_create(array $context, array $blocks = []): iterable
    {
        ...
        // line 3
        yield "    <turbo-stream action=\"append\" target=\"visites\">
        <template>
            <div id=\"";
        // line 5
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(("visite_" . (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 5, $this->source); })())), "html", null, true);
        yield "\">
                #";
        // line 6
...
";
    ...
    public function block_update(array $context, array $blocks = []): iterable
    {
        ...
        // line 13
        yield "    <turbo-stream action=\"update\" target=\"visite_";
...
";
    ...
    public function block_remove(array $context, array $blocks = []): iterable
    {
        ...
        // line 21
        yield "    <turbo-stream action=\"remove\" target=\"visite_";
...
";
    ...
    {
        return "broadcast/Visite.stream.html.twig";
    }
...
{% block create %}
    <turbo-stream action=\"append\" target=\"visites\">
        <template>
            <div id=\"{{ 'visite_' ~ id }}\">
                #{{ id }} created
            </div>
...
{% block update %}
    <turbo-stream action=\"update\" target=\"visite_{{ id }}\">
        <template>
            #{{ id }} updated
        </template>
    </turbo-stream>
...
{% block remove %}
    <turbo-stream action=\"remove\" target=\"visite_{{ id }}\"></turbo-stream>
{% endblock %}
", "broadcast/Visite.stream.html.twig", "/var/www/html/templates/broadcast/Visite.stream.html.twig");
    }
}
